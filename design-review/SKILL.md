...
**Local:** `.skystack/design-reports/design-audit-{domain}-{YYYY-MM-DD}.md`
...
```
Write to: `~/.skystack/projects/{slug}/{user}-{branch}-design-audit-{datetime}.md`
