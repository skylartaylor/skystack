...
echo '{"skill":"plan-design-review","timestamp":"TIMESTAMP","status":"STATUS","overall_score":N,"unresolved":N,"decisions_made":N}' >> ~/.skystack/projects/$SLUG/$BRANCH-reviews.jsonl
```
